export const supportServicePages = {
  ...
  '/suporte-ti-para-contadores': {
    ...
    outcomes: [
      ...
      { title: 'Opção recorrente', description: 'Plano mensal para escritórios que precisam de previsibilidade e acompanhamento.' },
    ],
    deliverables: ['Suporte a falhas do Windows e programas de escritório', 'Configuração de Microsoft 365, Outlook e Teams', 'Instalação e atualização de aplicativos compatíveis', 'Organização e transferência de arquivos', 'Orientação básica de backup e segurança', 'Plano recorrente definido conforme computadores e demanda'],
    ...
    faq: [
      ...
      { question: 'Existe plano mensal?', answer: 'Sim. O suporte remoto recorrente começa em R$ 289 por mês. A quantidade de computadores, chamados e prioridade é definida antes da contratação.' },
