export const supportServicePages = {
  ...
  '/suporte-ti-para-contadores': {
    ...
    outcomes: [
      ...
      { title: 'Foco na rotina contábil', description: 'Atendimento voltado aos programas de escritório e às tarefas que não podem ficar paradas.' },
    ],
    deliverables: ['Suporte a falhas do Windows e programas de escritório', 'Configuração de Microsoft 365, Outlook e Teams', 'Instalação e atualização de aplicativos compatíveis', 'Organização e transferência de arquivos', 'Orientação básica de backup e segurança', 'Resumo do atendimento e próximos passos'],
