...
// O campo `worth` é a linha que fica ao lado do preço dizendo o que está
// incluído e justifica o valor. Ela existe porque a tabela começa acima do
// que o mercado de suporte remoto pratica, e sem essa linha o preço fica
// indefensável contra um concorrente mais barato.
//
// Cada frase abaixo repete um compromisso que o site já publica em outro
// lugar (a triagem gratuita e o valor aprovado antes do serviço, o
// atendimento feito pelo próprio Ronael, a tela visível durante todo o
// atendimento e o retorno em até uma hora). Nada aqui é promessa nova.
//
// Faltam de propósito os dois argumentos que a especificação lista como
// dependentes de confirmação do dono, porque o site não os afirma hoje:
// prazo ("atendimento no mesmo dia") e parcelamento. Confirme se são
// praticados antes de acrescentá-los.
const services = [
  { id: 'diagnostico', worth: 'Triagem gratuita antes. Você aprova o valor final antes de qualquer serviço.', category: 'Diagnóstico', title: 'Diagnóstico remoto do computador', description: 'Triagem inicial gratuita pelo WhatsApp. Se for necessário acessar o computador, faço a análise técnica detalhada.', includes: ['Verificação do sistema', 'Análise dos sintomas', 'Orientação sobre o próximo passo'], audience: 'personal', price: 'R$ 39', page: '/suporte-tecnico-remoto' },
  { id: 'avulso-simples', worth: 'Escopo e valor confirmados antes do atendimento.', category: 'Avulso', title: 'Atendimento avulso simples', description: 'Ajuda remota pontual para uma dúvida ou ajuste simples no computador.', includes: ['Avaliação do problema', 'Ajuste pontual de software', 'Orientação após o atendimento'], audience: 'personal', price: 'R$ 60', page: '/suporte-tecnico-remoto' },
  { id: 'hora-tecnica', worth: 'Tempo necessário e valor total combinados antes de começar.', category: 'Por hora', title: 'Hora técnica de suporte remoto', description: 'Atendimento técnico cobrado por hora, conforme a necessidade identificada na triagem.', includes: ['Escopo combinado previamente', 'Atendimento remoto acompanhado', 'Orientação sobre o que foi realizado'], audience: 'personal', price: 'R$ 70/hora', page: '/suporte-tecnico-remoto' },
  { id: 'otimizacao', worth: 'Feito pelo próprio Ronael, com a tela visível durante todo o atendimento.', category: 'Mais procurado', title: 'Otimização completa de PC ou notebook', description: 'Revisão de inicialização, programas, armazenamento e configurações que afetam o desempenho.', includes: ['Limpeza de arquivos temporários', 'Revisão de programas desnecessários', 'Ajustes de desempenho'], featured: true, audience: 'personal', price: 'R$ 109', page: '/computador-lento' },
  { id: 'seguranca', worth: 'Você acompanha pela tela. Nada é removido sem a sua autorização.', category: 'Segurança', title: 'Limpeza de vírus e programas indesejados', description: 'Verificação de anúncios, extensões, programas suspeitos e configurações básicas de segurança.', includes: ['Revisão de programas instalados', 'Verificação do navegador', 'Orientações de segurança'], audience: 'personal', price: 'R$ 80', page: '/remocao-de-virus' },
  { id: 'gamer', worth: 'Ajuste conferido jogo a jogo, com você acompanhando pela tela.', category: 'Gamer', title: 'Otimização de PC para jogos', description: 'Queda de FPS, travamentos em partida, superaquecimento e drivers de vídeo desatualizados.', includes: ['Atualização limpa dos drivers de vídeo', 'Ajuste de energia, processos e overlays', 'Configuração gráfica por jogo'], gamer: true, audience: 'personal', price: 'R$ 129', page: '/otimizacao-pc-gamer' },
  { id: 'windows', worth: 'Diagnóstico antes de cobrar. O valor final é aprovado por você.', category: 'Windows', title: 'Correção de erros do Windows', description: 'Diagnóstico de atualizações com falha, mensagens de erro e recursos do sistema que pararam de funcionar.', includes: ['Análise dos erros', 'Reparo de componentes do sistema', 'Teste após a correção'], audience: 'personal', price: 'R$ 119', page: '/corrigir-erros-windows' },
  { id: 'programas', worth: 'Instalação acompanhada por você, com retorno em até 1 hora.', category: 'Programas', title: 'Programas, Office e drivers', description: 'Instalação, atualização e correção de programas usados no trabalho, estudo ou rotina pessoal.', includes: ['Instalação acompanhada', 'Correção de falhas', 'Atualização de drivers compatíveis'], audience: 'personal', price: 'R$ 79' },
  { id: 'backup', worth: 'Transferência acompanhada por você, sem intermediários.', category: 'Arquivos', title: 'Backup e transferência de arquivos', description: 'Organização de documentos e cópia para outro computador, armazenamento externo ou nuvem.', includes: ['Análise do que será protegido', 'Organização de pastas', 'Transferência acompanhada'], audience: 'personal', price: 'R$ 119' },
  { id: 'microsoft-365', worth: 'Atendimento direto com o responsável, sem equipe terceirizada.', category: 'Produtividade', title: 'Microsoft 365, Outlook e Teams', description: 'Configuração e correção das ferramentas Microsoft usadas por profissionais e pequenas equipes.', includes: ['Configuração de conta', 'Correção de sincronização', 'Orientação de uso'], audience: 'business', price: 'R$ 129' },
  { id: 'contadores', worth: 'Atendimento direto com o responsável, com retorno em até 1 hora.', category: 'Profissionais', title: 'Suporte remoto para contadores', description: 'Ajuda com Windows, Office, programas de escritório, arquivos e ferramentas de produtividade.', includes: ['Atendimento direto', 'Diagnóstico de software', 'Orientação após o serviço'], audience: 'business', price: 'R$ 139', page: '/suporte-ti-para-contadores' },
  { id: 'suporte-mensal', worth: 'Atendimento direto com o responsável, todos os dias das 9h à meia-noite.', category: 'Empresas', title: 'Plano mensal de suporte para pequenas empresas', description: 'Suporte remoto mensal para profissionais e pequenos negócios com 1 a 5 computadores.', includes: ['De 1 a 5 computadores', 'Plano de atendimento', 'Acompanhamento remoto'], audience: 'business', price: 'R$ 250/mês', page: '/plano-mensal-suporte-ti' },
]
...
function ServiceGlyph({ id }) {
  const shapes = {
    'avulso-simples': <><rect x="3.5" y="4" width="17" height="12" rx="2" /><path d="M8 20h8M12 16v4m-4-10 3 3 5-5" /></>,
    'hora-tecnica': <><circle cx="12" cy="12" r="9" /><path d="M12 6v6l4 2" /></>,
