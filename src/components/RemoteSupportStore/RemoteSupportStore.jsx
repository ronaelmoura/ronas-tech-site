...
const services = [
  { id: 'diagnostico', worth: 'Triagem gratuita antes. Você aprova o valor final antes de qualquer serviço.', category: 'Diagnóstico', title: 'Diagnóstico remoto do computador', description: 'Triagem inicial gratuita pelo WhatsApp. Se for necessário acessar o computador, faço a análise técnica detalhada.', includes: ['Verificação do sistema', 'Análise dos sintomas', 'Orientação sobre o próximo passo'], audience: 'personal', price: 'R$ 29', page: '/suporte-tecnico-remoto' },
