...
const services = [
  ...
  { id: 'empresas', category: 'Empresas', title: 'Suporte de TI para empresas', description: 'Ponto de partida para empresas: avaliamos equipe, máquinas e demanda antes de montar a proposta de atendimento.', includes: ['Suporte às estações de trabalho', 'Microsoft 365 para a equipe', 'Escopo e prioridade em proposta'], audience: 'business', price: 'R$ 289/mês', page: '/suporte-ti-para-empresas' },
