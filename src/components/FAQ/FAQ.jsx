...
const questions = [
  ...
  ['Quanto custa o atendimento?', 'O valor depende do problema e do serviço necessário. Primeiro você descreve os sintomas; depois recebe a avaliação e o valor para aprovar antes do trabalho começar.'],
