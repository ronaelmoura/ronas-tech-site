...
function Problems() {
  ...
  // O brilho e o "scan" das ilustrações rodam poucas vezes e param. Como a
  // seção só aparece depois do reveal de scroll, a animação é disparada
  // quando ela entra na tela — senão terminaria antes de alguém ver.
