...
function recommendService(event, problem) {
  ...
  window.dispatchEvent(new CustomEvent('select-support-service', { detail: { id: problem.serviceId, explanation: problem.recommendation, symptom: `${problem.title}. ${problem.text}` } }))
