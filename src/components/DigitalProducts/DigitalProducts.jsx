...
function DigitalProducts() {
  return <section className={styles.section} id="produtos-digitais" aria-labelledby="digital-products-title">
    <div className={styles.container}>
      ...
      <a className={styles.visual} href="/produtos-digitais" aria-label="Ver o Kit Financeiro Inteligente para MEI"><img src="/capa-kit-financeiro-mei-v2.webp" alt="Kit Financeiro Inteligente para MEI" loading="lazy" /></a>
    </div>
  </section>
}
